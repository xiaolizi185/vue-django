...
if system()=='Windows':
    ...
    class AIMService(win32serviceutil.ServiceFramework):   
        ...
        _svc_name_ = "AIMU"  #服务名 
        if PY2:
            _svc_display_name_ = "AIM update system"  #服务在windows系统中显示的名称 Automation infrastructure management
            _svc_description_ = "AIM update system" #服务的描述
        else:
...
define("port", default=12155, help="run on the given port", type=int)
